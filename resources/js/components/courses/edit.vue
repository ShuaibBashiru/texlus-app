    ...
    <div class="m-2">
     ...
     <div class="row mt-3">
        ...
        <div class="col-md-6 mt-3">
            ...
            <div class="input-group">
            <input type="number" id="discount" min="0" @change="checkNotANumber('discount')" v-model="parameters.discount" class="form-control form-control-sm shadow-none" placeholder="Discount" @input="calculateDiscount" required>
            </div>
        </div>
...
export default {
    ...
    getRecord: function(){
        ...
        this.parameters.post_summary = this.info.post_summary ? this.info.post_summary:''
        this.parameters.post_body = this.info.post_body ? this.info.post_body : ''
        ...
        this.parameters.post_link = this.info.post_link
        ...
        this.parameters.discounted_price = this.info.discounted_price
