...
<div class="border p-2 rounded">
    ...
    <table class="table table-hover table-bordered" id="listTable">
        ...
        <tr v-for="(d, index) in info.slice(startNumber, endNumber)" :key="index">
            ...
            <td class="" v-html="d.role_name ? d.role_name : ''"></td>
            <td class="text-center"> <small><a :href="'../rolepermission/'+encodeData(d.generated_id)">Edit <i class="bi bi-pencil"></i></a></small> </td>
