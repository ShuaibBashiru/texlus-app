...
<div class="col-12 m-0 p-0">
    ...
    <div class="m-1 mt-3">
        ...
        <div class="input-group">
            <select v-model="recipientOption" @change="updateRecipient" id="recipientOption" class="shadow-none form-control form-control-md form-control-sm-lg" required placeholder="Enter here" :disabled="disabled">
...
export default {
   ...
   validateForm: function(){
    ...
    sendPost: function(){
        ...
        axios.post('/notification/create', form).then(response => {
                this.button=this.btntxt;
