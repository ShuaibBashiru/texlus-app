...
<div class="col-12 m-0 p-0">
    ...
    <div class="m-1 mt-3">
            <label for="status_name" class="text-muted">Title</label>
        <div class="input-group">
            <input type="text" v-model="parameters.status_name" @keyup="oneSpace('status_name')" id="status_name" minlength="3" maxlength="200" class="shadow-none form-control form-control-md form-control-sm-lg" required placeholder="Enter here" :disabled="disabled">
        </div>
        <span class="text-danger" for="" v-if="errors.status_name && errors.status_name != ''"><small> <span v-text="errors.status_name[0]"></span> </small></span>
        </div>
        <div class="m-1 mt-3">
            <label for="summary" class="text-dark" title="required">Description <sup></sup></label>
            <textarea id="summary" placeholder="Enter here" class="form-control mt-1 mb-1" @keyup="oneSpace('status_description')" v-model="parameters.status_description" rows="1"></textarea>
...
export default {
    ...
    methods:{
        getRecords: function(){
            this.parameters.status_name = this.info.status_name;
            this.parameters.status_description = this.info.status_description;
  ...
  checkIfChanged: function(){
   ...
   validateForm: function(){
    ...
    sendPost: function(){
        ...
        axios.post('/statuses/update', form).then(response => {
                this.button=this.btntxt;
