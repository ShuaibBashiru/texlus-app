        ...
        <!-- Body component(s) -->
            ...
            <div class="mb-5 mt-4">
                ...
                <div class="row m-0">
                    ...
                    <user-attachment :server_message="{{ session('message') ?? $message ?? json_encode('') }}" :server_record="{{ session('record') ?? $record ?? json_encode('') }}"></user-attachment>
                    </div>
                </div>
