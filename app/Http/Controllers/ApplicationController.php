        ...
        try {
            ...
            if ($successful) {
                $returnData = [
                    ...
                    "status" => "success",
                    "statusmsg" => "success",
                    "msg" => "Your account was created successfully. To continue, an activation link to set your account's 
                    password has been sent to the email provided, kindly click the link to continue.",
                    "redirect" => "list",
                ];
            }else{
                $returnData = [
