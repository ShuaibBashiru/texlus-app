...
class StatusesController extends Controller
{
    ...
    public function manage($id){
        ...
        if ($record['status']=='success') {
            ...
            return redirect()->route('list_statuses')->with('message', json_encode($message));
        }
    }

    public function list(){
        return view('apps.statuses.record');
    }

    public function uploadBatch(){
        return view('apps.statuses.upload_record');
    }
    ...
    public function checkIfIdIsValid($data){
        $query = Statuses::where('deleted_status', '=', '0')
    ...
    public function create(Request $request){
       $request->validate([
            'status_name' => 'required|unique:statuses|max:100|min:2',
            'status_description' => 'nullable|max:100|min:2',
        ]);
        try {
            $exist = false;
            $failed = false;
            ...
            $record = [
                ...
                "status_name" => ucfirst(strtolower($request->input('status_name'))),
    ...
    public function update_record(Request $request){
        $request->validate([
            'status_name' => 'required|max:100|min:2',
            'status_description' => 'nullable|max:100|min:2',
...
try {
    ...
    $newid = $id;
    $update = Statuses::where('generated_id', '=', $newid)
...
// End loop
    ...
    try {
        ...
        $update = Statuses::where('generated_id', '=', $id)
                            ->update($row);
...
$query = Statuses::where('generated_id', '=', $id)
...
public function trash(Request $request)
    ...
    try {
        ...
        $row = [
            ...
            "deleted_status" => 1,
            "status_name" => 'deleted::'.$request->input('status_name'),
        ];
