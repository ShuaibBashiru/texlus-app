...
class PostController extends Controller
{
    ...
    public function list(){
        return view('apps.posts.record');
    }

    public function uploadBatch(){
        return view('apps.posts.upload_record');
    }

    public function createRecord(){
        return view('apps.posts.new_record');
    }
    ...
    public function fileExist($id){
        $query = Posts::where('deleted_status', '=', '0')
    ...
    public function update_record(Request $request){
        ...
        try {
            ...
            $record = [
                ...
                $query = Posts::where('generated_id', '=', $id)
                                ->update($record);
                if ($query) {
                $successful = true;
                }else{
...
try {
    ...
    $newid = $id;
    $update = Posts::where('generated_id', '=', $newid)
...
// End loop
    ...
    try {
        ...
        $update = Posts::where('generated_id', '=', $id)
                            ->update($row);
