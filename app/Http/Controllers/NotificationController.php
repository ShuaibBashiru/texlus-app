...
class NotificationController extends Controller
{
    ...
    public function list(){
        return view('apps.notification.record');
    }

    public function checkIfIdIsValid($data){
        $query = Notification::where('deleted_status', '=', '0')
    ...
    public function record($id)
    {
        ...
        $query = Notification::from('notification_tbl as t1')
                    ...
                    ->get(['t1.title', 't1.descriptions', 't1.recipient', 't1.expire_date', 't1.date_created', 't1.generated_id', 't1.updated_at'])->first();
       ...
       $request->validate([
        ...
        try {
            ...
            $record = [
                ...
                $query = Notification::insert($record);
                if ($query) {
                $successful = true;
                }else{
                $failed = true;
            ...
            if ($successful) {
                $returnData = [
                    ...
                    "status" => "success",
                    "statusmsg" => "success",
                    "msg" => "New message has been successfully posted, now redirecting...",
                    "redirect" => "list",
                ];
            }else{
                $returnData = [
                    ...
                    "status" => "failed",
                    "statusmsg" => "",
                    "msg" => "This message could not be posted right now! Please refresh and try again or report this error for further assistance.",
                ];
            }
        ...
        try {
            ...
            if ($successful) {
                $returnData = [
                    ...
                    "status" => "success",
                    "statusmsg" => "success",
                    "msg" => "The message was successfully updated, please wait a moment while reloading the changes you made.",
                    "redirect" => "",
                ];
            } else{
                $returnData = [
                    ...
                    "status" => "failed",
                    "statusmsg" => "",
                    "msg" => "This message could not be updated! Please refresh and try again.",
   ];
            }
...
try {
    ...
    $newid = $id;
    $update = Notification::where('generated_id', '=', $newid)
...
// End loop
    ...
    try {
        ...
        $update = Notification::where('generated_id', '=', $id)
                            ->update($row);
...
$query = Notification::where('generated_id', '=', $id)
...
public function trash(Request $request)
    ...
    try {
        ...
        $row = [
            ...
            "deleted_status" => 1,
            "title" => 'deleted::'.$request->input('title'),
        ];
